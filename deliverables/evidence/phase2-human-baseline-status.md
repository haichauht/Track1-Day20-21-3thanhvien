...
- Dataset có 24 scenarios và `scenario_id` duy nhất.
- Batch cuối chạy tutor thật 24/24; kết quả được lưu thành `results-v3-traced.jsonl`.
- LangSmith đã xác nhận 24 tutor traces và 24 judge traces, không có trace lỗi.
...
2. Mỗi người chấm độc lập cùng ít nhất 15–20 scenarios (khuyến nghị đủ 24), không xem
